...
\newcommand{\acrotarget}[2]{
    \acrodef{#1}{#2}
    \hypertarget{#1}{#1}: {#2}
} % do not use directly, use `generate_abbrs.py`
\newcommand{\aclink}[1]{\hyperlink{#1}{\ac{#1}}} % use this in text
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{abbr} % abbreviations (generate using `generate_abbrs.py`, and edit the generated file to add descriptions)
